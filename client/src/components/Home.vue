...
<script>
  ...
  export default {
    ...
    methods:{
      getMetadata() {
        this.loading = true
        this.generateTabs(this.testMetadata)
        ...
        Axios.get("http://127.0.0.1:5000/test")
            .then(response => {
              ...
              this.loading = false
              //this.generateTabs(response.data)
            })
            .catch(error => {
              console.log(error)
            })
